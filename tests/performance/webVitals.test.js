...
describe('Web Vitals Performance Tests', () => {
  ...
  beforeEach(async () => {
    ...
    await page.addScriptTag({
      path: require.resolve('web-vitals/dist/web-vitals.umd.js')
    })
  })
  ...
  it('should meet Core Web Vitals thresholds for home page', async () => {
    const vitals = await measureWebVitals('http://localhost:3000')
  ...
  it('should meet Core Web Vitals thresholds for customers page', async () => {
    const vitals = await measureWebVitals('http://localhost:3000/customers')
